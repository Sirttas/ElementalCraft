...
public class ElementalCraftJEIPlugin implements IModPlugin {
	...
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registry) {
		...
		if (ElementalCraftInteraction.isMekanismActive()) { // FIXME remove this soft dependency
			MekanismInteraction.addMillsToCrushing(registry);
		}
		if (ElementalCraftInteraction.isImmersiveEngineeringActive()) { // FIXME remove this soft dependency
