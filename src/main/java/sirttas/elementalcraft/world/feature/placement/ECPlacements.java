...
public class ECPlacements {
	...
	private static final DeferredRegister<PlacementModifierType<?>> DEFERRED_REGISTER = DeferredRegister.create(Registry.PLACEMENT_MODIFIER_REGISTRY, ElementalCraftApi.MODID);
