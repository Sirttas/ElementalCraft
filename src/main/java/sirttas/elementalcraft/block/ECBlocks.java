...
public class ECBlocks {
	...
	public static final DeferredHolder<@NotNull Block, @NotNull SmallElementContainerBlock> SMALL_CONTAINER = register(SmallElementContainerBlock.NAME, () -> new SmallElementContainerBlock(ECProperties.Blocks.CONTAINER));
	public static final DeferredHolder<@NotNull Block, @NotNull ElementContainerBlock> CONTAINER = register(ElementContainerBlock.NAME, () -> new ElementContainerBlock(ECProperties.Blocks.CONTAINER));
	public static final DeferredHolder<@NotNull Block, @NotNull ReservoirBlock> FIRE_RESERVOIR = register(ReservoirBlock.NAME_FIRE, () -> new ReservoirBlock(ElementType.FIRE, ECProperties.Blocks.CONTAINER));
	public static final DeferredHolder<@NotNull Block, @NotNull ReservoirBlock> WATER_RESERVOIR = register(ReservoirBlock.NAME_WATER, () -> new ReservoirBlock(ElementType.WATER, ECProperties.Blocks.CONTAINER));
	public static final DeferredHolder<@NotNull Block, @NotNull ReservoirBlock> EARTH_RESERVOIR = register(ReservoirBlock.NAME_EARTH, () -> new ReservoirBlock(ElementType.EARTH, ECProperties.Blocks.CONTAINER));
	public static final DeferredHolder<@NotNull Block, @NotNull ReservoirBlock> AIR_RESERVOIR = register(ReservoirBlock.NAME_AIR, () -> new ReservoirBlock(ElementType.AIR, ECProperties.Blocks.CONTAINER));
	public static final DeferredHolder<@NotNull Block, @NotNull CreativeElementContainerBlock> CREATIVE_CONTAINER = register(CreativeElementContainerBlock.NAME, () -> new CreativeElementContainerBlock(ECProperties.Blocks.CONTAINER));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull PedestalBlock> FIRE_PEDESTAL = register(PedestalBlock.NAME_FIRE, () -> new PedestalBlock(ElementType.FIRE, ECProperties.Blocks.DEFAULT_BLOCK_PROPERTIES));
	public static final DeferredHolder<@NotNull Block, @NotNull PedestalBlock> WATER_PEDESTAL = register(PedestalBlock.NAME_WATER, () -> new PedestalBlock(ElementType.WATER, ECProperties.Blocks.DEFAULT_BLOCK_PROPERTIES));
	public static final DeferredHolder<@NotNull Block, @NotNull PedestalBlock> EARTH_PEDESTAL = register(PedestalBlock.NAME_EARTH, () -> new PedestalBlock(ElementType.EARTH, ECProperties.Blocks.DEFAULT_BLOCK_PROPERTIES));
	public static final DeferredHolder<@NotNull Block, @NotNull PedestalBlock> AIR_PEDESTAL = register(PedestalBlock.NAME_AIR, () -> new PedestalBlock(ElementType.AIR, ECProperties.Blocks.DEFAULT_BLOCK_PROPERTIES));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull ElementPipeBlock> PIPE_RUDIMENTARY = register(ElementPipeBlock.NAME_RUDIMENTARY, () -> new ElementPipeBlock(ElementPipeBlock.PipeType.RUDIMENTARY, ECProperties.Blocks.PIPE));
	public static final DeferredHolder<@NotNull Block, @NotNull ElementPipeBlock> PIPE = register(ElementPipeBlock.NAME, () -> new ElementPipeBlock(ElementPipeBlock.PipeType.STANDARD, ECProperties.Blocks.PIPE));
	public static final DeferredHolder<@NotNull Block, @NotNull ElementPipeBlock> PIPE_IMPROVED = register(ElementPipeBlock.NAME_IMPROVED, () -> new ElementPipeBlock(ElementPipeBlock.PipeType.IMPROVED, ECProperties.Blocks.PIPE));
	public static final DeferredHolder<@NotNull Block, @NotNull ElementPipeBlock> PIPE_CREATIVE = register(ElementPipeBlock.NAME_CREATIVE, () -> new ElementPipeBlock(ElementPipeBlock.PipeType.CREATIVE, ECProperties.Blocks.PIPE));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull BudTypeShrineUpgradeBlock> SPRINGALINE_SHRINE_UPGRADE = registerNoOcclusion(BudTypeShrineUpgradeBlock.SPRINGALINE_NAME, p -> new BudTypeShrineUpgradeBlock(ShrineUpgrades.SPRINGALINE, "tooltip.elementalcraft.shrine_upgrade.springaline", p));
	public static final DeferredHolder<@NotNull Block, @NotNull BudTypeShrineUpgradeBlock> CERTUS_QUARTZ_SHRINE_UPGRADE = registerNoOcclusion(BudTypeShrineUpgradeBlock.CERTUS_QUARTZ_NAME, p -> new BudTypeShrineUpgradeBlock(ShrineUpgrades.CERTUS_QUARTZ, "tooltip.elementalcraft.shrine_upgrade.certus_quartz", p));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull SourceBlock> FIRE_SOURCE = register(SourceBlock.NAME_FIRE, () -> new SourceBlock(ElementType.FIRE, ECProperties.Blocks.SOURCE));
	public static final DeferredHolder<@NotNull Block, @NotNull SourceBlock> WATER_SOURCE = register(SourceBlock.NAME_WATER, () -> new SourceBlock(ElementType.WATER, ECProperties.Blocks.SOURCE));
	public static final DeferredHolder<@NotNull Block, @NotNull SourceBlock> EARTH_SOURCE = register(SourceBlock.NAME_EARTH, () -> new SourceBlock(ElementType.EARTH, ECProperties.Blocks.SOURCE));
	public static final DeferredHolder<@NotNull Block, @NotNull SourceBlock> AIR_SOURCE = register(SourceBlock.NAME_AIR, () -> new SourceBlock(ElementType.AIR, ECProperties.Blocks.SOURCE));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull DropExperienceBlock> CRYSTAL_ORE = register("inert_crystal_ore", () -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_ORE)));
	public static final DeferredHolder<@NotNull Block, @NotNull DropExperienceBlock> DEEPSLATE_CRYSTAL_ORE = register("deepslate_inert_crystal_ore", () -> new DropExperienceBlock(UniformInt.of(0, 3), BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE_IRON_ORE)));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull AmethystBlock> SPRINGALINE_BLOCK = register("springaline_block", () -> new AmethystBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_BLOCK)));
	public static final DeferredHolder<@NotNull Block, @NotNull AmethystClusterBlock> SPRINGALINE_CLUSTER = register("springaline_cluster", () -> new AmethystClusterBlock(7, 3, BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_CLUSTER)));
	public static final DeferredHolder<@NotNull Block, @NotNull AmethystClusterBlock> LARGE_SPRINGALINE_BUD = register("large_springaline_bud", () -> new AmethystClusterBlock(5, 3, BlockBehaviour.Properties.ofFullCopy(Blocks.LARGE_AMETHYST_BUD)));
	public static final DeferredHolder<@NotNull Block, @NotNull AmethystClusterBlock> MEDIUM_SPRINGALINE_BUD = register("medium_springaline_bud", () -> new AmethystClusterBlock(4, 3, BlockBehaviour.Properties.ofFullCopy(Blocks.MEDIUM_AMETHYST_BUD)));
	public static final DeferredHolder<@NotNull Block, @NotNull AmethystClusterBlock> SMALL_SPRINGALINE_BUD = register("small_springaline_bud", () -> new AmethystClusterBlock(3, 4, BlockBehaviour.Properties.ofFullCopy(Blocks.SMALL_AMETHYST_BUD)));
	...
	public static final DeferredHolder<@NotNull Block, @NotNull Block> SPRINGALINE_LANTERN = register("springaline_lantern", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.SEA_LANTERN)));

	public static final DeferredHolder<@NotNull Block, @NotNull ElementalEmberBlock> ELEMENTAL_EMBER = register(ElementalEmberBlock.NAME, () -> new ElementalEmberBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TORCH)));

	private static <T extends Block> DeferredHolder<@NotNull Block, @NotNull T> register(String name, Supplier<T> block) {
	...
	private static DeferredHolder<@NotNull Block, @NotNull IronBarsBlock> registerGlassPane(DeferredHolder<@NotNull Block, @NotNull ? extends TransparentBlock> block) {
