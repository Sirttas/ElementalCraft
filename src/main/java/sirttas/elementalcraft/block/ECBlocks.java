...
public class ECBlocks {
	...
	public static final DeferredHolder<Block, BudTypeShrineUpgradeBlock> SPRINGALINE_SHRINE_UPGRADE = registerNoOcclusion(BudTypeShrineUpgradeBlock.SPRINGALINE_NAME,  p -> new BudTypeShrineUpgradeBlock(ShrineUpgrades.SPRINGALINE, "tooltip.elementalcraft.shrine_upgrade.springaline", p));
	public static final DeferredHolder<Block, BudTypeShrineUpgradeBlock> CERTUS_QUARTZ_SHRINE_UPGRADE = registerNoOcclusion(BudTypeShrineUpgradeBlock.CERTUS_QUARTZ_NAME,  p -> new BudTypeShrineUpgradeBlock(ShrineUpgrades.CERTUS_QUARTZ, "tooltip.elementalcraft.shrine_upgrade.certus_quartz", p));
