...
public class ECRenderTypes {
	...
	public static final RenderType GHOST = RenderType.create(ElementalCraft.createRL("ghost").toString(), DefaultVertexFormats.BLOCK, GL11.GL_QUADS, 256,
			RenderType.State.builder().setTextureState(new RenderState.TextureState(AtlasTexture.LOCATION_BLOCKS, false, false)).setAlphaState(new RenderState.AlphaState(0.5F) {
				@Override
