...
public class PipeUpgradeCapabilities {
    ...
    public static final PipeUpgradeCapability<IRuneHandler, Void> RUNE_HANDLER = PipeUpgradeCapability.createVoid(ElementalCraftApi.identifier("rune_handler"), IRuneHandler.class);
