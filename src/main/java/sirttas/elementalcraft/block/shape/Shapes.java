...
public class Shapes {
	...
	private static final VoxelShape RS_SOURCE_NORTH = VoxelShapes.or(Block.box(4D, 4D, 0D, 12D, 12D, 2D), Block.box(6D, 6D, 2D, 10D, 10D, 5D));
	private static final VoxelShape RS_SOURCE_SOUTH = VoxelShapes.or(Block.box(4D, 4D, 14D, 12D, 12D, 16D), Block.box(6D, 6D, 11D, 10D, 10D, 14D));
	private static final VoxelShape RS_SOURCE_WEST = VoxelShapes.or(Block.box(0D, 4D, 4D, 2D, 12D, 12D), Block.box(2D, 6D, 6D, 5D, 10D, 10D));
	private static final VoxelShape RS_SOURCE_EAST = VoxelShapes.or(Block.box(14D, 4D, 4D, 16D, 12D, 12D), Block.box(11D, 6D, 6D, 14D, 10D, 10D));
	private static final VoxelShape RS_SOURCE_DOWN = VoxelShapes.or(Block.box(4D, 0D, 4D, 12D, 2D, 12D), Block.box(6D, 2D, 6D, 10D, 5D, 10D));
	private static final VoxelShape RS_SOURCE_UP = VoxelShapes.or(Block.box(4D, 14D, 4D, 12D, 16D, 12D), Block.box(6D, 11D, 6D, 10D, 14D, 10D));
	
	private static final VoxelShape RS_TARGET_NORTH = VoxelShapes.or(Block.box(7D, 7D, 0D, 9D, 9D, 3D), Block.box(6D, 6D, 3D, 10D, 10D, 5D));
	private static final VoxelShape RS_TARGET_SOUTH = VoxelShapes.or(Block.box(7D, 7D, 13D, 9D, 9D, 16D), Block.box(6D, 6D, 11D, 10D, 10D, 13D));
	private static final VoxelShape RS_TARGET_WEST = VoxelShapes.or(Block.box(0D, 7D, 7D, 3D, 9D, 9D), Block.box(3D, 6D, 6D, 5D, 10D, 10D));
	private static final VoxelShape RS_TARGET_EAST = VoxelShapes.or(Block.box(13D, 7D, 7D, 16D, 9D, 9D), Block.box(11D, 6D, 6D, 13D, 10D, 10D));
	private static final VoxelShape RS_TARGET_DOWN = VoxelShapes.or(Block.box(7D, 0D, 7D, 9D, 3D, 9D), Block.box(6D, 3D, 6D, 10D, 5D, 10D));
	private static final VoxelShape RS_TARGET_UP = VoxelShapes.or(Block.box(7D, 13D, 7D, 9D, 16D, 9D), Block.box(6D, 11D, 6D, 10D, 13D, 10D));
