...
public class SourceBreederPedestalRenderer implements ISourceRenderer<SourceBreederPedestalBlockEntity>, IRuneRenderer<SourceBreederPedestalBlockEntity> {
    ...
    public void render(@Nonnull SourceBreederPedestalBlockEntity pedestal, float partialTicks, @Nonnull PoseStack poseStack, @Nonnull MultiBufferSource buffer, int light, int overlay) {
        ...
        renderSource(poseStack, buffer, partialTicks, light, overlay, type, false, 1);
    }
}
