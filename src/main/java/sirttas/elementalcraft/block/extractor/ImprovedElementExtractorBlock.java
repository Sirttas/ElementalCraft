...
public class ImprovedElementExtractorBlock extends AbstractElementExtractorBlock {

	public static final String NAME = "improved_element_extractor";
	public static final MapCodec<ImprovedElementExtractorBlock> CODEC = simpleCodec(ImprovedElementExtractorBlock::new);
	...
	public ImprovedElementExtractorBlock(BlockBehaviour.Properties properties) {
		super(properties);
	}

	@Override
	protected @NotNull MapCodec<ImprovedElementExtractorBlock> codec() {
		return CODEC;
	}
