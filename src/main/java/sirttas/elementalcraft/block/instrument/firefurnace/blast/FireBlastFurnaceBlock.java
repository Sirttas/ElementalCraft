...
import sirttas.elementalcraft.block.instrument.firefurnace.AbstractFireFurnaceBlock;
...
public class FireBlastFurnaceBlock extends AbstractFireFurnaceBlock {
	...
	private static final VoxelShape OVEN = VoxelShapes.join(VoxelShapes.or(OVEN_SLAB, OVEN_SLAB_2, OVEN_GLASS), TOP_BOWL, IBooleanFunction.ONLY_FIRST);
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return new FireBlastFurnaceBlockEntity();
	}
