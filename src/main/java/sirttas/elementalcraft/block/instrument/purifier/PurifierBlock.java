...
public class PurifierBlock extends AbstractECContainerBlock {
	...
	private static final VoxelShape NORTH_OVEN = VoxelShapes.join(VoxelShapes.or(NORTH_OVEN_BLOCK, NORTH_OVEN_BLOCK_2), NORTH_EMPTY_SPACE, IBooleanFunction.ONLY_FIRST);
	...
	private static final VoxelShape SOUTH_OVEN = VoxelShapes.join(VoxelShapes.or(SOUTH_OVEN_BLOCK, SOUTH_OVEN_BLOCK_2), SOUTH_EMPTY_SPACE, IBooleanFunction.ONLY_FIRST);
	...
	private static final VoxelShape WEST_OVEN = VoxelShapes.join(VoxelShapes.or(WEST_OVEN_BLOCK, WEST_OVEN_BLOCK_2), WEST_EMPTY_SPACE, IBooleanFunction.ONLY_FIRST);
	...
	private static final VoxelShape EAST_OVEN = VoxelShapes.join(VoxelShapes.or(EAST_OVEN_BLOCK, EAST_OVEN_BLOCK_2), EAST_EMPTY_SPACE, IBooleanFunction.ONLY_FIRST);
