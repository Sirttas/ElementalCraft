...
public class CombustionSynthesizerBlockEntity extends AbstractContainerSynthesizerBlockEntity {
    ...
    public static final ResourceKey<@NotNull IConfigurableBlockEntityProperties> PROPERTIES_KEY = IConfigurableBlockEntityProperties.createKey(CombustionSynthesizerBlock.NAME);
    ...
    protected int getElementAmountForStack(ItemStack stack) {
        return Math.round(stack.getBurnTime(RecipeType.SMELTING, this.level.fuelValues()) * this.synthesisMultiplier);
    }
