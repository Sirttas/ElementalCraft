...
public class BreedingShrineBlock extends AbstractShrineBlock {
	...
	private static final VoxelShape BASE_CORE = VoxelShapes.or(Shapes.SHRINE_SHAPE, Block.box(5D, 12D, 5D, 11D, 14D, 11D));
	...
	private static final VoxelShape BASE_BOWL = VoxelShapes.join(BASE_BOWL_FULL, BASE_BOWL_VOID, IBooleanFunction.ONLY_FIRST);
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return hasTileEntity(state) ? new BreedingShrineBlockEntity() : null;
	}
