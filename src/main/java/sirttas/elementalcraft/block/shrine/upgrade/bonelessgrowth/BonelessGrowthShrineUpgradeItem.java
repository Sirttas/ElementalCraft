...
public class BonelessGrowthShrineUpgradeItem extends ShrineUpgradeItem {

    public BonelessGrowthShrineUpgradeItem(BonelessGrowthShrineUpgradeBlock block, Properties properties) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, Item.@Nullable TooltipContext tooltipContext, @NotNull TooltipDisplay display, @NotNull Consumer<Component> builder, @NotNull TooltipFlag flag) {
        builder.accept(Component.translatable("tooltip.elementalcraft.shrine_upgrade.boneless_growth").withStyle(ChatFormatting.BLUE));
