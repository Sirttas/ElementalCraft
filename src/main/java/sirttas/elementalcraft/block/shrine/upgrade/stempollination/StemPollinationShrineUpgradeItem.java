...
public class StemPollinationShrineUpgradeItem extends ShrineUpgradeItem {

    public StemPollinationShrineUpgradeItem(StemPollinationShrineUpgradeBlock block, Properties properties) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Item.TooltipContext tooltipContext, @NotNull TooltipDisplay display, @NotNull Consumer<Component> builder, @NotNull TooltipFlag flag) {
        builder.accept(Component.translatable("tooltip.elementalcraft.shrine_upgrade.stem_pollination").withStyle(ChatFormatting.BLUE));
