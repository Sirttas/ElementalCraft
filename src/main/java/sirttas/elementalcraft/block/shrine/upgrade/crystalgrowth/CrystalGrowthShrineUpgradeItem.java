...
public class CrystalGrowthShrineUpgradeItem extends ShrineUpgradeItem {

    public CrystalGrowthShrineUpgradeItem(CrystalGrowthShrineUpgradeBlock block, Properties properties) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Item.TooltipContext tooltipContext, @NotNull TooltipDisplay display, @NotNull Consumer<Component> builder, @NotNull TooltipFlag flag) {
        builder.accept(Component.translatable("tooltip.elementalcraft.shrine_upgrade.crystal_growth").withStyle(ChatFormatting.BLUE));
