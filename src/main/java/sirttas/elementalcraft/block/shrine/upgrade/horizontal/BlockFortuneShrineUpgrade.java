...
public class BlockFortuneShrineUpgrade extends AbstractBlockHorizontalShrineUpgrade {
	...
	private static final VoxelShape CORE_NORTH = Block.makeCuboidShape(6D, 6D, 4D, 10D, 10D, 8D);
	...
	private static final VoxelShape CORE_SOUTH = Block.makeCuboidShape(6D, 6D, 8D, 10D, 10D, 12D);
	...
	private static final VoxelShape CORE_WEST = Block.makeCuboidShape(4D, 6D, 6D, 8D, 10D, 10D);
	...
	private static final VoxelShape CORE_EAST = Block.makeCuboidShape(8D, 6D, 6D, 12D, 10D, 10D);
