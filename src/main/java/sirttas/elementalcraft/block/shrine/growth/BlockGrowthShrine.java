...
public class BlockGrowthShrine extends BlockECTileProvider {
	...
	private static final VoxelShape PIPE_UP_N = Block.makeCuboidShape(7D, 12D, 6D, 9D, 15D, 9D);
	private static final VoxelShape PIPE_UP_S = Block.makeCuboidShape(7D, 12D, 10D, 9D, 15D, 9D);
	private static final VoxelShape PIPE_UP_E = Block.makeCuboidShape(10D, 12D, 7D, 9D, 15D, 9D);
	private static final VoxelShape PIPE_UP_W = Block.makeCuboidShape(6D, 12D, 7D, 9D, 15D, 9D);
