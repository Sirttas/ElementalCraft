...
public class ECConfig {
	...
	public static class Common {
		...
		public final DoubleValue buddingShrinePeriode;
		...
		public Common(ForgeConfigSpec.Builder builder) {
			...
			buddingShrinePeriode = builder.comment("The nember of tick betwenn two budding Shrine activations.").defineInRange("buddingShrinePeriode", 600D, 0, 4800);
