...
public class MessageHandler {
	...
	public static void setup() {
		...
		CHANNEL.registerMessage(id++, SpellPropertiesMessage.class, SpellPropertiesMessage::encode, SpellPropertiesMessage::decode, SpellPropertiesMessage::handle); // NOSONAR - sonar don't like the i++ in the last registration
	}
}
