...
public class ECTags {
	...
	public static class Items {
		...
		public static final TagKey<Item> INFUSABLE_MACES = createTag("infusable/maces");
		public static final TagKey<Item> INFUSABLE_SPEARS = createTag("infusable/spears");
		...
		public static final TagKey<Item> PURE_ORES_SOURCES_RESIN_BLOCKS = createTag("pure_ores/sources/resin_blocks");
		public static final TagKey<Item> PURE_ORES_SOURCES_CLUSTERS = createTag("pure_ores/sources/clusters");
		public static final TagKey<Item> PURE_ORES_SOURCES_CLUMPS = createTag("pure_ores/sources/clumps");
		...
		public static final TagKey<Item> PURE_ORES_US_FOR_COOKING_RECIPES = createTag("pure_ores/us_for_recipes/cooking");
		...
		public static final TagKey<Item> STRIPPED_PALE_OAK = createTag("stripped_pale_oak");
	...
	public static class Blocks {
		...
		public static final TagKey<Block> STRIPPED_PALE_OAK = createTag("stripped_pale_oak");
