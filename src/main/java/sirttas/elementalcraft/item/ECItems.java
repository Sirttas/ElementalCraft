...
import sirttas.elementalcraft.item.source.receptacle.improved.EmptyImprovedReceptacleItem;
import sirttas.elementalcraft.item.source.receptacle.improved.ImprovedReceptacleItem;
...
public class ECItems {
	...
	@ObjectHolder(ElementalCraftApi.MODID + ":" + SourceStabilizerItem.NAME) public static final SourceStabilizerItem SOURCE_STABILIZER = null;
	@ObjectHolder(ElementalCraftApi.MODID + ":" + SourceAnalysisGlassItem.NAME) public static final SourceAnalysisGlassItem SOURCE_ANALYSIS_GLASS = null;
	...
	public static void registerItems(RegistryEvent.Register<Item> event) {
		...
		RegistryHelper.register(registry, new SourceStabilizerItem(), SourceStabilizerItem.NAME);
		RegistryHelper.register(registry, new SourceAnalysisGlassItem(), SourceAnalysisGlassItem.NAME);
