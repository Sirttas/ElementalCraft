...
public abstract class MekanismPureOreRecipeInjector<C extends IInventory, T extends IRecipe<C>> extends PureOreRecipeInjector<C, T> {

	protected MekanismPureOreRecipeInjector(IRecipeType<T> recipeType) {
		super(recipeType);
	}
