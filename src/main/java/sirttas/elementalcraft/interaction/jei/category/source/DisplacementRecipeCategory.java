...
public class DisplacementRecipeCategory extends AbstractECRecipeCategory<ElementType> {
	...
	public DisplacementRecipeCategory(IGuiHelper guiHelper) {
		super("elementalcraft.jei.displacement", createDrawableStack(guiHelper, new ItemStack(ECItems.EMPTY_RECEPTACLE)), guiHelper.createBlankDrawable(64, 32));
		addOverlay(guiHelper.createDrawable(ElementalCraftApi.createRL("textures/gui/overlay/extraction.png"), 0, 0, 24, 9), 21, 19);
	}
