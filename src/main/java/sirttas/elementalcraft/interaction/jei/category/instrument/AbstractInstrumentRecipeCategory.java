...
public abstract class AbstractInstrumentRecipeCategory<K extends IInstrument, T extends IInstrumentRecipe<K>> extends AbstractRecipeCategory<K, T> {
	...
	public void setIngredients(T recipe, IIngredients ingredients) {
		...
		ingredients.setInput(ECIngredientTypes.ELEMENT, new IngredientElementType(recipe.getElementType(), getGaugeValue(recipe.getElementPerTick() * recipe.getDuration())));
	}
