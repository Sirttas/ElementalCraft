...
public class SourceParticle extends AbstractElementParticle {
	...
	public static final IParticleMetaFactory<ElementTypeParticleData> FACTORY = s -> (data, worldIn, x, y, z, xSpeed, ySpeed, zSpeed) -> 
			new SourceParticle(worldIn, new Vector3d(x, y, z), s, data.getElementType());
	
	protected SourceParticle(ClientWorld worldIn, Vector3d coord, IAnimatedSprite sprite, ElementType type) {
