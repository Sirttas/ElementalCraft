...
public class PureOreLoaderTypes {
    ...
    public static final ResourceKey<Registry<PureOreLoaderType<? extends IPureOreLoader>>> KEY = ResourceKey.createRegistryKey(ElementalCraftApi.identifier(ECNames.PURE_ORE_LOADER_SERIALIZER));
