...
public class ShrineUpgradeProvider extends AbstractManagedDataProvider<ShrineUpgrade> {
	...
	public void run(@Nonnull HashCache cache) throws IOException {
        ...
        save(cache, ShrineUpgrade.Builder.create().predicate(MINING_PREDICATE).max(3).addBonus(BonusType.ELEMENT_CONSUMPTION, 1.3F).incompatibleWith(ShrineUpgrades.SILK_TOUCH), ShrineUpgrades.FORTUNE);
        ...
        save(cache, ShrineUpgrade.Builder.create().match(ECBlocks.GROWTH_SHRINE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 5F).addBonus(BonusType.SPEED, 4F).incompatibleWith(ShrineUpgrades.STEM_POLLINATION), ShrineUpgrades.BONELESS_GROWTH);
        save(cache, ShrineUpgrade.Builder.create().match(ECBlocks.VACUUM_SHRINE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 500F).addBonus(BonusType.SPEED, 20F).addBonus(BonusType.RANGE, 0.5F).incompatibleWith(ShrineUpgrades.VORTEX), ShrineUpgrades.PICKUP);
		save(cache, ShrineUpgrade.Builder.create().match(ECBlocks.VACUUM_SHRINE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 2F).addBonus(BonusType.RANGE, 0.75F).incompatibleWith(ShrineUpgrades.PICKUP), ShrineUpgrades.VORTEX);
		save(cache, ShrineUpgrade.Builder.create().match(ECBlocks.SWEET_SHRINE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 5F).addBonus(BonusType.SPEED, 2F).incompatibleWith(ShrineUpgrades.STRENGTH), ShrineUpgrades.NECTAR);
		...
		save(cache, ShrineUpgrade.Builder.create().match(ECBlocks.GROWTH_SHRINE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 4F).addBonus(BonusType.SPEED, 3F).addBonus(BonusType.RANGE, 0.5F).incompatibleWith(ShrineUpgrades.BONELESS_GROWTH), ShrineUpgrades.STEM_POLLINATION);
		...
		save(cache, ShrineUpgrade.Builder.create().match(ECBlocks.BUDDING_SHRINE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 2F).addBonus(BonusType.SPEED, 2F).addBonus(BonusType.CAPACITY, 2F), SpringalineShrineUpgradeBlock.NAME);
		...
		save(cache, ShrineUpgrade.Builder.create().predicate(ACCELERATION_PREDICATE).addBonus(BonusType.SPEED, 0.5F), AccelerationShrineUpgradeBlock.NAME);
		save(cache, ShrineUpgrade.Builder.create().match(ECTags.Blocks.SHRINES_UPGRADABLES_RANGE).addBonus(BonusType.RANGE, 1.5F).addBonus(BonusType.ELEMENT_CONSUMPTION, 1.2F).addBonus(BonusType.SPEED, 1.2F), RangeShrineUpgradeBlock.NAME);
		save(cache, ShrineUpgrade.Builder.create().predicate(PROTECTION_PREDICATE).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 3F), ShrineUpgrades.PROTECTION);
		save(cache, ShrineUpgrade.Builder.create().match(ECTags.Blocks.SHRINES).max(1).addBonus(BonusType.CAPACITY, 5F).addBonus(BonusType.ELEMENT_CONSUMPTION, 1.1F).addBonus(BonusType.SPEED, 1.1F), CapacityShrineUpgradeBlock.NAME);
		...
		save(cache, ShrineUpgrade.Builder.create().predicate(STRENGTH_PREDICATE).addBonus(BonusType.STRENGTH, 2F).addBonus(BonusType.ELEMENT_CONSUMPTION, 1.2F).incompatibleWith(ShrineUpgrades.NECTAR), ShrineUpgrades.STRENGTH);
		save(cache, ShrineUpgrade.Builder.create().match(ECTags.Blocks.SHRINES).max(2).addBonus(BonusType.CAPACITY, 1.25F).addBonus(BonusType.ELEMENT_CONSUMPTION, 0.75F).addBonus(BonusType.SPEED, 0.8F), OptimizationShrineUpgradeBlock.NAME);
	}
