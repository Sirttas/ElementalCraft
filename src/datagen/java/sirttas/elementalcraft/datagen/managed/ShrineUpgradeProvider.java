...
public class ShrineUpgradeProvider extends AbstractManagedDataBuilderProvider<ShrineUpgrade, ShrineUpgrade.Builder> {
	...
	public void collectBuilders() {
        ...
        builder(ShrineUpgrades.BONELESS_GROWTH).match(ECBlocks.GROWTH_SHRINE.get()).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 1.5F).addBonus(BonusType.SPEED, 10F).addBonus(BonusType.CAPACITY, 1.5F).incompatibleWith(ShrineUpgrades.STEM_POLLINATION);
        builder(ShrineUpgrades.PICKUP).match(ECBlocks.VACUUM_SHRINE.get()).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 500F).addBonus(BonusType.SPEED, 20F).addBonus(BonusType.RANGE, 0.5F).incompatibleWith(ShrineUpgrades.VORTEX, ShrineUpgrades.STRENGTH);
		...
		builder(ShrineUpgrades.STEM_POLLINATION).match(ECBlocks.GROWTH_SHRINE.get()).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 4F).addBonus(BonusType.SPEED, 3F).addBonus(BonusType.RANGE, 0.5F).incompatibleWith(ShrineUpgrades.BONELESS_GROWTH);
		...
		builder(ShrineUpgrades.CRYSTAL_HARVEST).match(ECBlocks.BUDDING_SHRINE.get()).max(1).addBonus(BonusType.ELEMENT_CONSUMPTION, 1.5F);
