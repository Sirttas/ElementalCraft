...
public class ECBiomeModifierProvider extends AbstractECJsonCodecProvider<BiomeModifier> {
    ...
    protected void gather() {
        ...
        addSources(SourceFeature.NAME_NETHER, ECTags.Biomes.HAS_SOURCE_NETHER);
        addSources(SourceFeature.NAME_OCEAN, ECTags.Biomes.HAS_SOURCE_OCEAN);
        addSources(SourceFeature.NAME_LUSH_CAVE, ECTags.Biomes.HAS_SOURCE_LUSH_CAVE);
    ...
    private BiomeModifier addSources(String feature, TagKey<Biome> biomes) {
        return add(feature, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(createHolderSet(biomes), createHolderSet(Registry.PLACED_FEATURE_REGISTRY, feature), GenerationStep.Decoration.TOP_LAYER_MODIFICATION));
    }
}
