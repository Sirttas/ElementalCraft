...
public class ECServerDataGenerators {

	private ECServerDataGenerators() {}
	...
	public static void gatherData(GatherDataEvent.Server event) {
		...
		event.addProvider(new AdvancementProvider(output, registries, List.of(
				new ECAdvancementGenerator(),
				new ECPickupAdvancementGenerator())));
		...
		event.addProvider(new BookDataProvider(output, registries));

		DatagenInteraction.get().getServerProviders(output, registries).forEach(event::addProvider);
	}
}
