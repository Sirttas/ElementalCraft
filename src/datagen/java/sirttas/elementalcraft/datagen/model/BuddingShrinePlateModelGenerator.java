...
public class BuddingShrinePlateModelGenerator implements ECModelGenerator {
    ...
    public static final ECModelGenerator.Factory FACTORY = (_, _, _,  _, buddingShrinePlateModelOutput, modelOutput) -> new BuddingShrinePlateModelGenerator(buddingShrinePlateModelOutput, modelOutput);
