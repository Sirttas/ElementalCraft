...
public class OreShrineGameTests {
    ...
    private static final List<BlockPos> OUTSIDE_RANGE = List.of(
            ...
            new BlockPos(13, 0, 12),
            new BlockPos(12, 0, 13),
    ...
    public static void should_mineInRange(GameTestHelper helper) {
        ShrineGameTestHelper.forcePeriods(helper, new BlockPos(13, 1, 13), IN_RANGE.size() + OUTSIDE_RANGE.size());
        helper.succeedIf(() -> {
