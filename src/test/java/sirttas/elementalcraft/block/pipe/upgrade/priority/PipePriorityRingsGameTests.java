...
public class PipePriorityRingsGameTests {
    ...
    public static void should_transferWestFirst(DynamicTest test) {
        test.registerGameTestTemplate(() -> ECStructureTemplateBuilder.withSize(2, 3, 4)
                ...
                .pipeline(1, 1, 1, pipeline -> pipeline
    ...
    public static void should_transferFarFirst(DynamicTest test) {
        test.registerGameTestTemplate(() -> ECStructureTemplateBuilder.withSize(2, 3, 6)
