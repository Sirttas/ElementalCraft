...
public class CrackingSynthesizerGameTests {
    ...
    public static final Supplier<StructureTemplate> CRACKING_SYNTHESIZER_TEMPLATE = ECStructureTemplateBuilder.lazy(11, 3, 11, builder -> builder
    ...
    public static final Supplier<StructureTemplate> CRACKING_SYNTHESIZER_WITH_RUNE_TEMPLATE = ECStructureTemplateBuilder.lazy(13, 3, 13, builder -> builder
