...
public class ElementalCraftApi {
	...
	public static final IDataManager<SourceTrait> SOURCE_TRAIT_MANAGER = IDataManager.builder(SourceTrait.class, SourceTrait.FOLDER).withIdSetter(SourceTrait::setId).build();
